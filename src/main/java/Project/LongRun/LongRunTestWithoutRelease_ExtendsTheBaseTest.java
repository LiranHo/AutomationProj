...
public class LongRunTestWithoutRelease_ExtendsTheBaseTest extends BaseTest{
    ...
    public void initParamters(boolean longRun, boolean adb_commands_parallel){
        longRun=true;
        adb_commands_parallel=false;
    ...
    //need to send the current thread device
    public void beforeLongRun(Device device){
        testName= "LongRunTestWithoutRelease";
        Main.sout("Info!","***** LongRunTestWithoutRelease START for device "+device.getSerialnumber()+ " ****");
